...
2. Run `sotgraph usages "<symbol>" [--json]` or `sot_usages` to locate all calling sites.
...
- Run `sotgraph doctor` to audit database health, schema v5, and page allocations.
